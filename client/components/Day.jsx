...
//console.log(daily)
    return(
        <div className="day--container">
            ...
            <p className="uv">High: {daily?.maxtemp_f}&deg;F</p>
            <p className="high">High: {daily?.maxtemp_f}&deg;F</p>
            <p className="wind-speed">Low: {daily?.mintemp_f}&deg;F</p>
            <p className="wind-dir">Winds up to {daily?.maxwind_mph}MPH</p>
            <p className="cloud">Rain {daily?.totalprecip_in} inches</p>
